package com.quangminh.jpainheritancejoined;

import com.quangminh.jpainheritancejoined.service.BookstoreService;
...
public class JpaInheritanceJoinedApplication {


    private final BookstoreService bookstoreService;

    public JpaInheritanceJoinedApplication(BookstoreService bookstoreService) {
        this.bookstoreService = bookstoreService;
    }

    public static void main(String[] args) {
        SpringApplication.run(JpaInheritanceJoinedApplication.class, args);
    }
    @Bean
