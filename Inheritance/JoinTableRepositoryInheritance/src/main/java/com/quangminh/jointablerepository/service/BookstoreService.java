package com.quangminh.jointablerepository.service;

import com.quangminh.jointablerepository.entity.Author;
import com.quangminh.jointablerepository.entity.Book;
import com.quangminh.jointablerepository.entity.Ebook;
import com.quangminh.jointablerepository.entity.Paperback;
import com.quangminh.jointablerepository.repository.AuthorRepository;
import com.quangminh.jointablerepository.repository.BookRepository;
import com.quangminh.jointablerepository.repository.EbookRepository;
import com.quangminh.jointablerepository.repository.PaperbackRepository;
...
public class BookstoreService {
    ...
    public BookstoreService(AuthorRepository authorRepository,
                            ...
                            EbookRepository ebookRepository, EbookRepository ebookRepository1) {

        this.authorRepository = authorRepository;
        this.bookRepository = bookRepository;
        this.paperbackRepository = paperbackRepository;

        this.ebookRepository = ebookRepository1;
    }
