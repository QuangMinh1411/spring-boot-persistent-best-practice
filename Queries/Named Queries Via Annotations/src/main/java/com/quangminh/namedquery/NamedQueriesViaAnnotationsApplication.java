package com.quangminh.namedquery;

import com.quangminh.namedquery.entity.Author;
import com.quangminh.namedquery.service.BookstoreService;
...
public class NamedQueriesViaAnnotationsApplication {


    private final BookstoreService bookstoreService;

    public NamedQueriesViaAnnotationsApplication(BookstoreService bookstoreService) {
        this.bookstoreService = bookstoreService;
    }

    public static void main(String[] args) {
        SpringApplication.run(NamedQueriesViaAnnotationsApplication.class, args);
    }
    @Bean
