package com.quangminh.pesimisticforceincrement;

import com.quangminh.pesimisticforceincrement.service.BookstoreService;
...
public class PermisticForceIncrementApplication {


    private final BookstoreService bookstoreService;

    public PermisticForceIncrementApplication(BookstoreService bookstoreService) {
        this.bookstoreService = bookstoreService;
    }

    public static void main(String[] args) {
        SpringApplication.run(PermisticForceIncrementApplication.class, args);
    }
    @Bean
