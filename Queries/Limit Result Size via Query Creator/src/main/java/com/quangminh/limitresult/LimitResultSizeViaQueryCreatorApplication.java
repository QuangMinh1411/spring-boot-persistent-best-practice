package com.quangminh.limitresult;

import com.quangminh.limitresult.dto.AuthorDto;
import com.quangminh.limitresult.service.BookstoreService;
...
public class LimitResultSizeViaQueryCreatorApplication {


    private final BookstoreService bookstoreService;

    public LimitResultSizeViaQueryCreatorApplication(BookstoreService bookstoreService) {
        this.bookstoreService = bookstoreService;
    }

    public static void main(String[] args) {
        SpringApplication.run(LimitResultSizeViaQueryCreatorApplication.class, args);
    }
