package com.example.namedquerypf.service;

import com.example.namedquerypf.entity.Author;
import com.example.namedquerypf.repository.AuthorRepository;
...
public class BookstoreService {
    ...
    public List<Author> fetchAuthorsViaSort() {
        return authorRepository.fetchViaSort(Sort.by(Sort.Direction.DESC, "name"));
    }

    public List<Author> fetchAuthorsViaSortWhere() {
        return authorRepository.fetchViaSortWhere(30, Sort.by(Sort.Direction.DESC, "name"));
    }
