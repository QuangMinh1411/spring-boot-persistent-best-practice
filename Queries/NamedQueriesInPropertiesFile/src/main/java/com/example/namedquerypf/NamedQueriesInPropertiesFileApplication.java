package com.example.namedquerypf;

import com.example.namedquerypf.entity.Author;
import com.example.namedquerypf.service.BookstoreService;
...
public class NamedQueriesInPropertiesFileApplication {


    private final BookstoreService bookstoreService;

    public NamedQueriesInPropertiesFileApplication(BookstoreService bookstoreService) {
        this.bookstoreService = bookstoreService;
    }

    public static void main(String[] args) {
        SpringApplication.run(NamedQueriesInPropertiesFileApplication.class, args);
    }
    @Bean
