package com.quangminh.noordercolumn;

import com.quangminh.noordercolumn.service.ShoppingCartService;
...
public class CollectionNoOrderColumnApplication {


    private final ShoppingCartService shoppingCartService;

    public CollectionNoOrderColumnApplication(ShoppingCartService shoppingCartService) {
        this.shoppingCartService = shoppingCartService;
    }

    public static void main(String[] args) {
        SpringApplication.run(CollectionNoOrderColumnApplication.class, args);
    }
